"""
Physics-Informed Neural Network (PINN) Implementation using PyTorch
...
- Functional_linear: A helper function that applies a linear transformation followed by a sine activation,
                    used within the functional forward pass.
